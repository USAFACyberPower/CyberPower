...
class App(QWidget):
    def __init__(self):
        ...
        self.btn_loc3_bolt.clicked.connect(self.btn_loc3_bolt_clicked)
        ...
        self.btn_loc4_bolt.clicked.connect(self.btn_loc4_bolt_clicked)
        ...
        # Fault Location 5 - C Phase Resistive Faults
        ...
        self.btn_loc5_bolt.clicked.connect(self.btn_loc5_bolt_clicked)
        ...
        # Fault Location 6 - C Phase Resistive Faults
        ...
        self.btn_loc6_bolt.clicked.connect(self.btn_loc6_bolt_clicked)
